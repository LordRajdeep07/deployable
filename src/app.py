...
USE_CHATGPT_API = os.getenv("USE_CHATGPT_API", "false").lower() == "true"
...
firebase_config = {
    "apiKey": os.getenv("FIREBASE_API_KEY", "AIzaSyDxEVoMUMGYgbit8uYbjITLw1TcFhAu2zU"),
    "authDomain": os.getenv("FIREBASE_AUTH_DOMAIN", "alpha-8d676.firebaseapp.com"),
    "projectId": os.getenv("FIREBASE_PROJECT_ID", "alpha-8d676"),
    "storageBucket": os.getenv("FIREBASE_STORAGE_BUCKET", "alpha-8d676.firebasestorage.app"),
    "messagingSenderId": os.getenv("FIREBASE_MESSAGING_SENDER_ID", "47580545885"),
    "appId": os.getenv("FIREBASE_APP_ID", "1:47580545885:web:d67c304a39a886c555deb4"),
    "measurementId": os.getenv("FIREBASE_MEASUREMENT_ID", "G-1Y46N5QES1")
}
...
try:
    ...
    # This is a dummy model that always returns "Low" risk
    class FallbackModel:
        def predict(self, X):
            return [0] * len(X)  # Always predict 0 (Low risk)
    model = FallbackModel()
...
if __name__ == "__main__":
    ...
    # Get port from environment variable (needed for Heroku)
